...
class _EscenariosPageState extends State<EscenariosPage>
  ...
  /// 🔹 Ir al juego con el escenario seleccionado y regresar monedas
  Future<void> _goToGame(String escenarioImage) async {
    // Abrimos GamePage y esperamos a que termine
    final int? coinsEarned = await Navigator.push<int>(
      ...
      MaterialPageRoute(
        builder: (_) => GamePage(
          ...
          escenario: escenarioImage,
        ),
      ),
    );

    // Cuando GamePage termina (y hace pop(context, _coinsThisRun))
    // regresamos a MyHomePage pasando esas monedas
    Navigator.pop(context, coinsEarned ?? 0);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: AnimatedBackground( // Tema de animación que viene desde el main
        child: Column(
          children: [
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  onTapUp: (_) {
                    ...
                    // 🔹 Si solo quieres regresar sin sumar monedas:
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () => _goToGame(escenario['image']!),
